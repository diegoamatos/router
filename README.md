...
[![Source Code](http://img.shields.io/badge/source-simpsyst/router-blue.svg?style=flat-square)](https://github.com/diegoamatos/router)
[![PHP from Packagist](https://img.shields.io/packagist/php-v/simpsyst/router.svg?style=flat-square)](https://packagist.org/packages/simpsyst/router)
[![Latest Version](https://img.shields.io/github/release/diegoamatos/router.svg?style=flat-square)](https://github.com/diegoamatos/router/releases)
[![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE)
[![Build](https://img.shields.io/scrutinizer/build/g/diegoamatos/router.svg?style=flat-square)](https://scrutinizer-ci.com/g/diegoamatos/router)
[![Quality Score](https://img.shields.io/scrutinizer/g/diegoamatos/router.svg?style=flat-square)](https://scrutinizer-ci.com/g/diegoamatos/router)
[![Total Downloads](https://img.shields.io/packagist/dt/simpsyst/router.svg?style=flat-square)](https://packagist.org/packages/simpsyst/router)
...
<form action="" method="POST">
    ...
    <input type="text" name="first_name" value="Diego"/>
    <input type="text" name="last_name" value="Matos"/>
    <input type="text" name="email" value="oi@diegomatos.com"/>
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://localhost/simpsyst/router/exemple/spoofing/",
  ...
  CURLOPT_POSTFIELDS => "first_name=Diego&last_name=Matos&email=oi%40diegomatos.com",
...
Please see [CONTRIBUTING](https://github.com/diegoamatos/router/blob/master/CONTRIBUTING.md) for details.
...
- [All Contributors](https://github.com/diegoamatos/router/contributors) (This Rock)

## License

The MIT License (MIT). Please see [License File](https://github.com/diegoamatos/router/blob/master/LICENSE) for more information.
